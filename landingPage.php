<div id="story1" class="inner box backgr">
                                    ...
                                    <div class="round font40 textpole shadow" style="background:rgba(255, 255, 255, 1);height:140px; margin-top:60px;">
                                        ...
                                        <div class="featuresColumn7 centertext shadow textpole"><div style="text-align:left;margin-left:40%;width:200px;"><img src="./img/logo-klasa.png" class="efekt1" style="max-height:80px; margin-top:-10px;" /></div></div>
