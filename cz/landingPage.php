...
<p class="uroven2">1.5.      Znění obchodních podmínek může prodávající měnit či dopl�?ovat. Tímto ustanovením nejsou dotčena práva a povinnosti vzniklá po dobu účinnosti předchozího znění obchodních podmínek.</p></div>

    <div class="toggle2"><h2 id="led2"><span id="uzivatelsky-ucet">2. </span>UŽIVATELSKÝ ÚČET</h2>
<p class="uroven2">2.1.      Na základě registrace kupujícího provedené na webové stránce může kupující přistupovat do svého uživatelského rozhraní. Ze svého uživatelského rozhraní může kupující provádět objednávání zboží v případě, že to webové rozhraní obchodu umož�?uje, může kupující provádět objednávání zboží též bez registrace přímo z webového rozhraní obchodu.</p>
...
<p class="uroven2">2.6.      Kupující bere na vědomí, že uživatelský účet nemusí být dostupný nepřetržitě, a to zejména s ohledem na nutnou údržbu hardwarového a softwarového vybavení prodávajícího, popř. nutnou údržbu hardwarového a softwarového vybavení třetích osob.</p></div>
    <div class="toggle3"><h2 id="led3" class="uroven2"><span id="kupni-smlouva">3. </span>UZAV�?ENÍ KUPNÍ SMLOUVY</h2>
...
<div class="toggle6"><h2 id="led6" class="uroven2"><span id="doprava-zdarma">6. </span>P�?EPRAVA A DOD�?NÍ ZBOŽÍ</h2>
...
<div class="toggle7"><h2 id="led7" class="uroven2"><span id="vadne-plneni">7. </span>PR�?VA Z VADNÉHO PLNĚNÍ</h2>
...
<div class="toggle8"><h2 id="led8" class="uroven2"><span id="dalsi-prava-povinnosti">8. </span>DALŠÍ PR�?VA A POVINNOSTI SMLUVNÍCH STRAN</h2>
...
<p class="uroven2">9.2.      Kupující souhlasí se zpracováním těchto svých osobních údajů: jméno a příjmení, adresa bydliště, identifikační číslo, da�?ové identifikační číslo, adresa elektronické pošty a telefonní číslo (dále společně vše jen jako „osobní údaje“).</p>
<p class="uroven2">9.3.      Kupující souhlasí se zpracováním osobních údajů prodávajícím, a to pro účely realizace práv a povinností z kupní smlouvy a pro účely vedení uživatelského účtu. Nezvolí-li kupující jinou možnost, souhlasí se zpracováním osobních údajů prodávajícím také pro účely zasílání informací a obchodních sdělení kupujícímu. Souhlas se zpracováním osobních údajů v celém rozsahu dle tohoto článku není podmínkou, která by sama o sobě znemož�?ovala uzavření kupní smlouvy.</p>
...
<div class="toggle10"><h2 id="led10" class="uroven2"><span id="obchodni-sdeleni">10. </span>ZASÍL�?NÍ OBCHODNÍCH SDĚLENÍ A UKL�?D�?NÍ COOKIES</h2>
...
<div class="toggle11"><h2 id="led11" class="uroven2"><span id="dorucovani">11. </span>DORUČOV�?NÍ</h2>
...
<div class="toggle12"><h2 id="ustanoveni" class="uroven2"><span id="ustanoveni">12. </span>Z�?VĚREČN�? USTANOVENÍ</h2>
