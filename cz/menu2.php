                ...
                <form class="search-whisperer-wrap-v1 search-whisperer-wrap" action="#" method="post" itemprop="potentialAction" itemscope="" itemtype="http://schema.org/SearchAction">
                    <fieldset>
                        ...
                        <div class="large-8 medium-8 small-12 left">
                            ...
                            <input type="search" name="string" itemprop="query-input" class="s-word" placeholder="Hledat.." onfocus="this.placeholder = ''" onblur="this.placeholder = 'Hledat...'" autocomplete="off" style="width: 64%;
