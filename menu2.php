<div class="radek shadow hlavicka" style="margin-bottom: 74px;float:left !important;position:relative !important; top:48px !important; /*border-top:1px solid #d7d6da;border-bottom:1px solid #d7d6da;*/z-index:9999;
      height: 50px;
