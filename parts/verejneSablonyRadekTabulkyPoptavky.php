...
<tr style="cursor: pointer;" onclick="window.location.href = './zobrazitPoptavku.php?nabidnout=<?php echo $polozkaId; ?>';">
    <td><?php echo "P".$polozkaId; ?></td>
    <td><?php echo $kategorieName; ?></td>
    <td><?php echo $polozkaDatum; ?></td>    
    <td onclick="window.location.href = './profil.php?spolecnos=<?php echo $userId; ?>';" ><?php echo $userJmeno; ?></td>
    <td class="bluebutton" >Zobrazit nabídku</td>
</tr>
