...
$stmt = $conn->prepare("SELECT kategorie.nazev FROM usersconkategorienabidky AS con INNER JOIN users ON  con.userId = users.Id INNER JOIN kategorie ON kategorie.Id = con.kategorieId WHERE users.Id = ? ");
